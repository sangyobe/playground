...
int main(int /*argc*/, char ** /*argv*/) {
  ...
  std::cout << on_bright_green << "message on bright green" << reset
            << std::endl;
  std::cout << on_bright_yellow << "message on bright yellow" << reset
            << std::endl;
  std::cout << on_bright_blue << "message on bright blue" << reset << std::endl;
  std::cout << on_bright_magenta << "message on bright magenta" << reset
            << std::endl;
  std::cout << on_bright_cyan << "message on bright cyan" << reset << std::endl;
  std::cout << on_bright_white << "message on bright white" << reset
            << std::endl;
  std::cout << "default message" << std::endl;
  std::cout << std::endl;
  ...
  std::cout << bright_red << on_white << "bright red on white" << reset
            << std::endl;
  std::cout << blue << on_bright_yellow << "blue on bright yellow" << reset
            << std::endl;
  std::cout << std::endl;

  // test bright foreground and bright background colors
  std::cout << bright_red << on_bright_white << "bright red on bright white"
            << reset << std::endl;
  std::cout << bright_blue << on_bright_yellow << "bright blue on bright yellow"
            << reset << std::endl;
  std::cout << std::endl;
  ...
  std::clog << "formatted " << yellow << "std::clog" << reset << " message"
            << std::endl;
  std::cerr << "formatted " << red << "std::cerr" << reset << " message"
            << std::endl;
  std::cout << std::endl;
